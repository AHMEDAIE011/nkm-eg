          ...
          <nav class="navbar navbar-expand-md bg-dark navbar-dark">
              ...
              <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                  <div class="navbar-nav mr-auto">
                      <a href="{{ route('frontend.index') }}" class="nav-item nav-link ">{{__('home.home')}}</a>
                      <div class="nav-item dropdown">
                          <a href="{{ route('frontend.categories.posts') }}" class="nav-link dropdown-toggle" data-toggle="dropdown">{{__('home.products')}}</a>
                          <div class="dropdown-menu">
                            <a href="{{ route('frontend.categories.posts') }}"
                                class="dropdown-item" title="All Category">{{__('home.allCategory')}}</a>
                              @foreach ($categories as $category)
                              @if (App::getLocale() == 'ar')
                              <a href="{{ route('frontend.category.posts', $category->slug) }}"
                                class="dropdown-item" title="{{ $category->name }}">{{ $category->name_ar }}</a>
                              @else
                              <a href="{{ route('frontend.category.posts', $category->slug) }}"
